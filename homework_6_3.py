...
должен быть защищенным и ссылаться на словарь, содержащий элементы: оклад и премия,
...
a = Position('Bob', 'Marley', 'muz', 100, 500)
print(a.get_full_name())
print(a.position)
print(a.get_total_income())
b = Position('Freddie', 'Mercury', 'showman', 500, 700)
